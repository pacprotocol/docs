...
```bash
pacprotocol-cli sendtoaddress "address" amount ( "comment" "comment_to" subtractfeefromamount use_is use_ps conf_target "estimate_mode")
```
...
## Examples
```bash
pacglobal-cli sendtoaddress "XwnLY9Tf7Zsef8gMGL2fhWA9ZmMjt4KPwG" 0.1
```

```bash
pacglobal-cli sendtoaddress "XwnLY9Tf7Zsef8gMGL2fhWA9ZmMjt4KPwG" 0.1 "donation" "seans outpost"
```

```bash
pacglobal-cli sendtoaddress "XwnLY9Tf7Zsef8gMGL2fhWA9ZmMjt4KPwG" 0.1 "" "" true
```
