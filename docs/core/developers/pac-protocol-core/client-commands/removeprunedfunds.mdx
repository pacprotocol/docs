...
```bash
pacprotocol-cli removeprunedfunds "txid"
```
...
## Examples
```bash
pacglobal-cli removeprunedfunds "a8d0c0184dde994a09ec054286f1ce581bebf46446a512166eae7628734ea0a5"
```
...
```bash
 pacprotocol-cli help removeprunedfunds
```
