...
If you skipped the [Step 3 from Getting Started](/developers/pac-protocol-core/getting-started#step-3---creating-systemctl-service-optional-recommended), you can run daemon by following step:
...
Or if skipped [Step 3 from Getting Started](/developers/pac-protocol-core/getting-started#step-3---creating-systemctl-service-optional-recommended):
