...
If you need absolute control of the transactions, you can create your own & broadcast transaction without using [sendtoaddress](/docs/core/developers/pac-protocol-core/client-commands/sendtoaddress) or [sendmany](/docs/core/developers/pac-protocol-core/client-commands/sendmany)
...
```
[createrawtransaction documentation](/docs/core/developers/pac-protocol-core/client-commands/createrawtransaction)
...
```
[signrawtransaction documentation](/docs/core/developers/pac-protocol-core/client-commands/signrawtransaction)
...
```
[signrawtransaction documentation](/docs/core/developers/pac-protocol-core/client-commands/sendrawtransaction)
