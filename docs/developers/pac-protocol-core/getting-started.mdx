...
daemon=1
```
You can find more options under [Daemon Options](/developers/pac-protocol-core/daemon-options)
...
It can take some time to sync fully. Luckly we have a solution for that in order to sync it faster - please see the following tutorial [Install Bootstrap](/developers/pac-protocol-core/install-bootstrap)
...
Please see [Client Commands](/developers/pac-protocol-core/client-commands/getaddressbalance) for more information of commands usage & http