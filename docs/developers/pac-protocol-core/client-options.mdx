...
# Client Options (pacprotocol-cli)
...
<Tabs
  defaultValue="0"
  values={[
    {label: 'Send a command', value: "0"},
    {label: 'Send a command (with named arguments)', value: "1"},
    {label: 'List commands', value: "2"},
    {label: 'Get help for a command', value: "3"},
  ]}>
  <TabItem value="0">
    <CodeBlock>
  ...
  <TabItem value="1">
      <CodeBlock>
          pacprotocol-cli [options] -named &lt;command&gt; [name=value] ...
      </CodeBlock>
    </TabItem>
  <TabItem value="2">
      <CodeBlock>
          pacprotocol-cli [options] help
      </CodeBlock>
    </TabItem>
  <TabItem value="3">
      <CodeBlock>
          pacprotocol-cli [options] help &lt;command&gt;
      </CodeBlock>
    </TabItem>
</Tabs>
